...
export default function StayFocused() {
  return (
    <>
      <section className="stayFocused">
        <div className="getOrder">
          ...
          <div className="enumeration">
            <p>
              ...
              <span>50% less time spent on tasks.</span>
            </p>
            <p>
              <svg
                width="39"
              ...
              <span>2x productivity boost in the first 2 weeks.</span>
            </p>
            <p>
              <svg
                width="39"
              ...
              <span>97% of users report reduced procrastination.</span>
            </p>
          </div>
